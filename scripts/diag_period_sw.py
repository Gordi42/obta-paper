"""Test the sensitivity of the diag period to the diagnosed imbalance in sw model."""
...
def compute_imbalance(initial_condition: str,
    ...
    diag_period : float
        The diagnostic period in between both balancing.
    rossby_number : float
    ...
    imbalance = obta_paper.diagnosed_imbalance(
        ...
        diagnosing_period=diag_period/rossby_number,
    )
...
sweep = SweepExpMPI(
    ...
    parameters = {
        ...
        "diag_period": np.linspace(1, 20, 20),
        "rossby_number": [0.05, 0.1, 0.3],
    },
    return_values = {"imbalance": float},
    save_path = "data/diag_period_sw.nc",
)
