"""Compute the geostrophic projection error of time averaging."""
...
sweep = SweepExpMPI(
    ...
    parameters = {
        ...
        "number_chunks": np.arange(1, 18),
    },
    return_values = {"averaging_error": float},
    save_path = "data/geo_proj_error_equidistant_sw.nc",
)
...
sweep.priority.data += sweep.parameters["number_chunks"]
