"""Compute the imbalance vs rossby number in the shallow water model."""
...
# Skip experiments of ob with more than 1 averaging chunk
sweep.status.loc[{"balancing_method": ["ob"],
                  "number_chunks": [2, 3]}] = "S"
